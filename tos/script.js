...
const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ2bHhpbXF1Y3lxc3FxZm5kam14Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg0ODYyNzgsImV4cCI6MjA4NDA2MjI3OH0.rZV1D9J4ilJ5Qu8ZZzxAnV6Sy3BQ8loL9JZOldqvr9Y"
...
async function checkIfAccepted(hwid) {
  try {
    const response = await fetch(`${SUPABASE_URL}/rest/v1/tos_acceptances?hwid=eq.${hwid}`, {
      headers: {
...
async function saveAcceptance(hwid) {
  try {
    const response = await fetch(`${SUPABASE_URL}/rest/v1/tos_acceptances`, {
      method: "POST",
      headers: {
        apikey: SUPABASE_ANON_KEY,
        "Content-Type": "application/json",
